...
function xmlToJson(xml) {
      ...
      if (node.hasChildNodes()) {
        ...
        for (var i = 0; i < childNodes.length; i++) {
          ...
          if (childNode.nodeType === Node.ELEMENT_NODE) {
            ...
            obj[childNode.nodeName].push({});
            traverse(childNode, obj[childNode.nodeName][obj[childNode.nodeName].length - 1]);
  ...
  traverse(xmlDoc.firstChild, result);
  return result;
}
